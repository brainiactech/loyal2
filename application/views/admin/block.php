            ...
            <th> Action</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="<?php echo base_url() . "index.php/block/block_user/" . $user_details[$i]->user_id; ?>">Block</a>
<a href="<?php echo base_url() . "index.php/block/unblock_user/" . $user_details[$i]->user_id; ?>">Unblock</a>
</td>
                    </tr>
                    <?php } ?>
