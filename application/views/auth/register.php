...
<body>
  <div class="app no-padding no-footer layout-static bg- ">
             ...
             <span class="text-danger"> <?php echo form_error('lastname'); ?></span>
              ...
              <fieldset class="form-group">
               ...
               <span class="text-danger"><?php echo form_error('phone_number'); ?></span>
                ...
                <input type="hidden" name="phone_number2"  class="form-control form-control-lg" id="phone_number2" placeholder="+234............" value="<?php echo set_value('phone_number2'); ?>">
               <span class="text-danger"><?php echo form_error('phone_number2'); ?></span>
             
                <input type="hidden" name="spons_phone_number"  class="form-control form-control-lg" id="spons_phone_number" placeholder="+234............" required value="<?php echo set_value('spons_phone_number'); ?>">
               <span class="text-danger"><?php echo form_error('spons_phone_number'); ?></span>
              </fieldset>
                             
                                <input type="hidden" name="account_number" class="form-control form-control-lg" id="account_number" placeholder="must be 10 digits" value="<?php echo set_value('account_number'); ?>"> 
              <span class="text-danger"><?php echo form_error('account_number'); ?></span>
              
              
                
                <input type="hidden" name="account_name" class="form-control form-control-lg" id="account_name" placeholder="your account name" value="<?php echo set_value('account_name'); ?>"> 
              <span class="text-danger"><?php echo form_error('account_name'); ?></span>
             
               
                 
                <input type="hidden" name="amount1"  class="form-control form-control-lg" id="amount1" placeholder="amount1" value="<?php echo set_value('0'); ?>" required>
	...
	<option value="ZW">Zimbabwe</option>
                ...
                <input type="text" name="email"  class="form-control form-control-lg" id="email" placeholder="trade@tbc2naira.trade" value="<?php echo set_value('email'); ?>">
               <span class="text-danger"><?php echo form_error('email'); ?></span>
              </fieldset>
               
              
                 <fieldset class="form-group">
                <label for="username">Enter Referral's Username</label>
                <input type="text" name="referrer_id" id="referrer_id" placeholder="enter your referral username" required class="form-control form-control-lg ">
                 </fieldset>
