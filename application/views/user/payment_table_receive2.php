<link rel="stylesheet" href="<?php echo base_url(); ?>styles/loaders.css"><div class="card" >
  <link rel="stylesheet" href="<?php echo base_url(); ?>bower_components/toastr/toastr.min.css">
                  ...
                  <div class="card">
                        <div class="card-header no-bg b-a-0"><h3>Transferring TBC</h3><span><h6>(new)</h6></span></div>
                        <div class="card-block">
                                ...
                                <thead>
                                    <tr>
                                     <th>The Bitcoin Coin Address</th>  
                                ...
                                <tr>
                                    ...
                                    <td>
                                      ...
                                      <?php echo $value->bitcoin_address; ?>
                                    </td>
                    ...
                    <script type="text/javascript">
                        ...
                        $(document).ready(function() { 
                          $(".upload_file").on('change', function(){
                              ...
                              // return;
                              jQuery.ajax({
                                url: '<?php echo base_url(); ?>index.php/upload/upload_filetbc?payment_id='+payment_id,
                                data: data,
                                cache: false,
                                contentType: false,
                                processData: false,
