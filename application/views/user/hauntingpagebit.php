...
<form method="post" action="<?php echo site_url('index.php/huntbit/confirm_reserve'); ?>" name="data_register">
                                                                 <thead>                               
         <tr> 
...
<td><input type="textbox" name="amount_to_pay" id= "amount_to_pay" value="<?php echo $get_data[$i]->amount; ?>"</td></input>
<input type="hidden" name="amount_to_receive" id="amount_to_receive" value="<?php echo $get_data[$i]->amount; ?>"></input>
 <input type="hidden" name="receiver" id="receiver" value="<?php echo $get_data[$i]->user_id; ?>"></input>
       <input type="hidden" name="requester_db" id="requester_db" value="<?php echo $get_data[$i]->comfirm_paid_users; ?>"></input>
