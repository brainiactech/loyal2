            ...
            <th> Action</th>
                ...
                <tbody>
                   <?php for ($i = 0; $i < count($comfirm_paid_users); $i++) { ?>
                    <tr>
                        <td><?php echo ($i+1); ?></td>
                    <td><input type="textbox" name="receiver_id[<?php echo ($i+1); ?>]" id="receiver_id[<?php echo ($i+1); ?>]" value="<?php echo $comfirm_paid_users[$i]->user_id; ?>"></td></input>
                        <td><input type="textbox" id="firstname" name="firstname"  value="<?php echo $comfirm_paid_users[$i]->first_name; ?>"</td></input>
                        <td><input type="textbox" value="<?php echo $comfirm_paid_users[$i]->last_name; ?>"</td></input>
<td><input type="textbox" name="amount_to_pay" id= "amount_to_pay" value="<?php echo $comfirm_paid_users[$i]->amount; ?>"</td></input>
<input type="hidden" name="amount_to_receive" id="amount_to_receive" value="<?php echo $comfirm_paid_users[$i]->amount; ?>"></input>
 <input type="hidden" name="receiver" id="receiver" value="<?php echo $comfirm_paid_users[$i]->user_id; ?>"></input>
                         ...
                         <td><a href="<?php echo base_url() . "index.php/hunt/reserve_user" . $comfirm_paid_users->[$i]user_id; ?>">Reserve</a></td>
