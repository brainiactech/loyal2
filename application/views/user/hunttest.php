          ...
          <?php $this->load->view('partials/nav'); ?>
            <div class="main-content">
                <div class="content-view">
                  ...
                  <p> <h5>EDIT AMOUNT BEFORE CLICKING ON RESERVE, UNLESS YOU ARE RESERVING A WHOLE PROJECT</h5>
</div>
                    <div id="male">
<h6> The next list will be released by 8 a.m on Monday </h6>
</div>
                        <div class="container"  >
  <div class="row">
    <div class="col-xs-12">
      <div id="female" class="table-responsive">
