...
<td><input type="textbox" disabled name="amount_to_pay" id= "amount_to_pay" value="<?php echo $comfirm_paid_users[$i]->amount; ?>"</td></input>
<input type="hidden" name="amount_to_receive" id="amount_to_receive" value="<?php echo $comfirm_paid_users[$i]->amount; ?>"></input>
 <input type="hidden" name="receiver" id="receiver" value="<?php echo $comfirm_paid_users[$i]->user_id; ?>"></input>
                 ...
                 <td><a href="<?php echo base_url() . "index.php/huntbit/reserve_user/" . $comfirm_paid_users[$i]->comfirm_paid_users; ?>">Reserve</a></td>
